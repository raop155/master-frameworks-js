      ...
      <section id="content">
        ...
        <form class="mid-form" @submit.prevent="mostrarUsuario">
          <div class="form-group">
            ...
            <div v-if="submitted && !$v.user.nombre.minLength">Este campo debe tener màs caracteres</div>
          </div>
          ...
          <div class="form-group">
            ...
            <div
              v-if="submitted && !$v.user.apellidos.minLength"
            >Este campo debe tener màs caracteres</div>
          </div>
          ...
          <div class="form-group">
            ...
            <div v-if="submitted && !$v.user.bio.minLength">Este campo debe tener màs caracteres</div>
          </div>
